...
with row2[1]:
    loan_tenure_months = st.number_input("Loan Tenure Months",min_value=0, step=1,value=20)
with row2[2]:
...
with row4[0]:
    resident_type = st.selectbox("Resident Type", ['Owned', 'Rented', 'Mortgage'])
with row4[1]:
...
if st.button("Calculate Risk"):
    ...
    # print(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency, delinquency_ratio,credit_utilization_ratio,
    #                                             num_open_accounts,resident_type,loan_purpose,loan_type)
